...
func (c *greeterClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/hellogrpc.Greeter/Hello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hellogrpc.Greeter/Hello",
	}
...
var fileDescriptor0 = []byte{
	...
	0x3a, 0x4c, 0x11, 0x8c, 0x6b, 0xe4, 0xc2, 0xc5, 0xee, 0x5e, 0x94, 0x9a, 0x5a, 0x92, 0x5a, 0x24,
	0x64, 0xc9, 0xc5, 0x0a, 0xd6, 0x22, 0x24, 0xae, 0x87, 0xb0, 0x1c, 0xd9, 0x22, 0x29, 0x51, 0x4c,
	0x89, 0x82, 0x9c, 0x4a, 0x25, 0x86, 0x24, 0x36, 0xb0, 0x1b, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff,
	0xff, 0x2c, 0x0c, 0x15, 0x8c, 0xb6, 0x00, 0x00, 0x00,
}
